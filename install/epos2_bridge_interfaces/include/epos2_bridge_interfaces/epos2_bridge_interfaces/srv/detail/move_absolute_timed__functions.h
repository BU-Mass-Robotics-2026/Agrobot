...
// IWYU pragma: private, include "epos2_bridge_interfaces/srv/move_absolute_timed.h"


#ifndef EPOS2_BRIDGE_INTERFACES__SRV__DETAIL__MOVE_ABSOLUTE_TIMED__FUNCTIONS_H_
#define EPOS2_BRIDGE_INTERFACES__SRV__DETAIL__MOVE_ABSOLUTE_TIMED__FUNCTIONS_H_
...
#include "epos2_bridge_interfaces/srv/detail/move_absolute_timed__struct.h"
...
/// Initialize srv/MoveAbsoluteTimed message.
/**
 ...
 * )) before or use
 * epos2_bridge_interfaces__srv__MoveAbsoluteTimed_Request__create()
...
/// Finalize srv/MoveAbsoluteTimed message.
/**
...
/// Create srv/MoveAbsoluteTimed message.
/**
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * epos2_bridge_interfaces__srv__MoveAbsoluteTimed_Request__init().
...
/// Destroy srv/MoveAbsoluteTimed message.
/**
 * It calls
 * epos2_bridge_interfaces__srv__MoveAbsoluteTimed_Request__fini()
...
/// Check for srv/MoveAbsoluteTimed message equality.
/**
...
/// Copy a srv/MoveAbsoluteTimed message.
/**
...
/// Initialize array of srv/MoveAbsoluteTimed messages.
/**
...
/// Finalize array of srv/MoveAbsoluteTimed messages.
/**
 * It calls
 * epos2_bridge_interfaces__srv__MoveAbsoluteTimed_Request__fini()
...
/// Create array of srv/MoveAbsoluteTimed messages.
/**
 * It allocates the memory for the array and calls
 * epos2_bridge_interfaces__srv__MoveAbsoluteTimed_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/// Destroy array of srv/MoveAbsoluteTimed messages.
/**
 * It calls
 * epos2_bridge_interfaces__srv__MoveAbsoluteTimed_Request__Sequence__fini()
 * on the array,
...
/// Check for srv/MoveAbsoluteTimed message array equality.
/**
...
/// Copy an array of srv/MoveAbsoluteTimed messages.
/**
 * This functions performs a deep copy, as opposed to the shallow copy that
 * plain assignment yields.
 *
 ...
 * )) before or use
 * epos2_bridge_interfaces__srv__MoveAbsoluteTimed_Response__create()
 * to allocate and initialize the message.
 * \return true if initialization was successful, otherwise false
 */
ROSIDL_GENERATOR_C_PUBLIC_epos2_bridge_interfaces
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * epos2_bridge_interfaces__srv__MoveAbsoluteTimed_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_epos2_bridge_interfaces
...
/**
 * It calls
 * epos2_bridge_interfaces__srv__MoveAbsoluteTimed_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_epos2_bridge_interfaces
...
/**
 * It allocates the memory for the array and calls
 * epos2_bridge_interfaces__srv__MoveAbsoluteTimed_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_epos2_bridge_interfaces
...
/**
 * It calls
 * epos2_bridge_interfaces__srv__MoveAbsoluteTimed_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
 ...
 * )) before or use
 * epos2_bridge_interfaces__srv__MoveAbsoluteTimed_Event__create()
 * to allocate and initialize the message.
 * \return true if initialization was successful, otherwise false
 */
ROSIDL_GENERATOR_C_PUBLIC_epos2_bridge_interfaces
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * epos2_bridge_interfaces__srv__MoveAbsoluteTimed_Event__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_epos2_bridge_interfaces
...
/**
 * It calls
 * epos2_bridge_interfaces__srv__MoveAbsoluteTimed_Event__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_epos2_bridge_interfaces
...
/**
 * It allocates the memory for the array and calls
 * epos2_bridge_interfaces__srv__MoveAbsoluteTimed_Event__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_epos2_bridge_interfaces
...
/**
 * It calls
 * epos2_bridge_interfaces__srv__MoveAbsoluteTimed_Event__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // EPOS2_BRIDGE_INTERFACES__SRV__DETAIL__MOVE_ABSOLUTE_TIMED__FUNCTIONS_H_
