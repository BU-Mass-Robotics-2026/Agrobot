...
Lifted from epos2_bridge.epos2_j3_bridge.RawSocketCAN so the Copley bridge can
share the same low-level CAN interface without taking a runtime dependency on
epos2_bridge as a Python package.
"""
