// This template demonstrates how to use the MoveGroupInterface to plan and execute a motion along a Cartesian path to a position goal
// It initializes a ROS 2 node, creates a MoveGroupInterface for the "arm" group, and plans/executes along a Cartesian path to a position goal
