...
#---> This is a persistent flag, NOT a one-shot check!!!!
...
class TomatoPicker(Node):
    def __init__(self):
        ...
        self.publisher_ = self.create_publisher(PoseArray, '/agrobot/pick_target', 10)
    ...
    # ------------------------------------------------------------------
    MAX_REACH = 0.8  # 80 cm — update once you have real kinematics
