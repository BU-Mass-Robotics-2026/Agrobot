...
def generate_launch_description():
    ...
    return LaunchDescription([
        DeclareLaunchArgument("enable_j2", default_value="true"),
        DeclareLaunchArgument("enable_j3", default_value="true"),
        DeclareLaunchArgument("enable_j4", default_value="true"),
        DeclareLaunchArgument("enable_j5", default_value="true"),
        DeclareLaunchArgument("enable_j6", default_value="true"),
